...
const Review = () => {
    const { data: feedback = [], isLoading: isLoadingAssignments, isError: isErrorAssignments, error: assignmentError } = useQuery({
        queryKey: ['feedback'],
        queryFn: async () => {
            try {
...
<div className='my-7'>
    <Heading center={true} title={'Real Feedback from Real Users'}></Heading>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-1 justify-center'>
            ...
            {
                feedback.map(feed =>     <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
